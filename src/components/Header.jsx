...
export function Header() {
    ...
    const userMenu = (
        <div className="col-md-3 dropdown text-end">
            <div onClick={() => setMenuVisibility(!menuVisibility)} to="/" className="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
